...
import com.eneserdogan.besinlerkitabi.adapter.BesinRecyclerAdapter
import com.eneserdogan.besinlerkitabi.viewmodel.BesinListesiViewModel
...
class BesinListesiFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        swipeRefreshlayout.setOnRefreshListener {//Swipe edildiğinde çalışır
            besinYukleniyor.visibility=View.VISIBLE
            besinHataMesaj.visibility=View.GONE
            besinListRecycler.visibility=View.GONE
            viewModel.refreshFromInternet()
            swipeRefreshlayout.isRefreshing=false//Kendi progressini iptal ediyoruz
        }
